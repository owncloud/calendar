OC.L10N.register(
    ...
    "Error requesting resource on remote server. This could possibly be related to a certificate mismatch" : "S'ha produït un error en sol·licitar recursos al servidor remot. Això podria estar relacionat amb un desajust de certificat",
    ...
    "CalDAV address for clients" : "Adreça per a clients CalDAV",
    ...
    "Email has been sent." : "El correu ha estat  enviat",
    "There was an issue while sending your email." : "Hi ha hagut un problema mentre s'enviava el correu",
    "group" : "grup",
    "Details" : "Detalls",
    ...
    "Please add a title." : "Siusplau afegeix un títol",
    "Please select a calendar." : "sisplau sel·lecciona un calendari",
    ...
    "Fourth" : "Quart",
    "Last" : "Últim",
    "How about getting started by importing some calendars?" : "Comencem per importar alguns calendaris?",
    ...
    "Please enter a valid WebCal-URL" : "Sisplau entra una WebCal-URL vàlida.",
    "Severe error in webcal proxy. Please contact administrator for more information." : "Error server al proxi del webcal. sisplau, contacta amb l'administrador del sistema",
    ...
    "Delete this event " : "Esborra aquest event",
    "Cancel" : "Cancel·la",
    "More ..." : "Més",
    "Create" : "Crea",
    "Update" : "Actualitza",
    ...
    "Visibility when sharing" : "Visibilitat al compartir ",
    "Export" : "Exporta",
    "%s has published the calendar %s" : "1%s ha publicat el calendari 1%s",
    "Hello," : "Hola,",
    ...
    "Month" : "Mes",
    "Today" : "Avui",
    "Some events in this calendar are broken. Please check the JS console for more info." : "Alguns esdeveniments del calendari estan trencats. Sisplau comprova la consola de JS per obtenir més informació",
    "Share Calendar" : "Comparteix el calendari",
    "Shared" : "Compartit",
    "More" : "Més",
    "Edit" : "Edita",
    "Link" : "Enllaç",
    "iCal link" : "Enllaç de l'iCal",
    "Download" : "Descàrrega",
    ...
    "Maybe you got a wrong link or the calendar was unshared?" : "Pots tenir un enllac trencat a un calendari inexistent?",
    ...
    "Support for advanced rules will be added with subsequent updates." : "El suport per regles avançades serà afegit en properes actualitzacions",
    "Reset repeating rule" : "Reinicialitza la regla de repetició",
    "Repeat every:" : "Repeteix cada:",
    "Repeat on:" : "Repeteix:",
    "Repeat on every:" : "Repeteix cada:",
    "of each month" : "de cada mes",
    "End:" : "Final:",
    "never" : "mai",
    "event(s)" : "esdeveniment(s)",
    ...
    "New calendar" : "Calendari nou",
    "File is empty" : "El fitxer està buit.",
    "Import scheduled" : "Importació programada",
    ...
    "No Calendars selected for import" : "No hi ha calendaris seleccionats per importar",
