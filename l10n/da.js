OC.L10N.register(
    ...
    "Email has been sent." : "Emailen er sendt",
    "There was an issue while sending your email." : "Der opstod en fejl under afsendelsen af din email.",
    "group" : "gruppe",
    "Details" : "Detaljer",
    "Attendees" : "Deltagere",
    ...
    "Please select a calendar." : "Vælg en kalender.",
    "The event can not end before it starts." : "Begivenheden kan ikke slutte før det begynder.",
    "Global" : "Global",
    "None" : "Ingen",
    "Never" : "Aldrig",
    "Daily" : "Dagligt",
    "Weekly on {weekday}" : "Ugentligt på {weekday}",
    "Monthly on {day}" : "Månedlig på {day} ",
    "Yearly on {day} of {month}" : "Årligt på {day} i {month} ",
    "Custom" : "Valgfrit",
    "Day(s)" : "Dag(e)",
    "Week(s)" : "Uge(r)",
    "Month(s)" : "Måned(er)",
    ...
    "Fourth" : "Fjerde",
    "Last" : "Sidste",
    "How about getting started by importing some calendars?" : "Hvad med at begynde med at importere nogle kalendere?",
    ...
    "%s has published the calendar %s" : "%s har udgivet kalenderen %s",
    "Hello," : "Hej,",
    "We wanted to inform you that %s has published the calendar {boldstart}%s{boldend}." : "Vi vil informere dig om at %s har udgivet kalenderen {boldstart}%s{boldend}.",
    "Click here to access it" : "klik her for at tilgå det",
    "Cheers!" : "Hej!",
    "We wanted to inform you that %s has published the calendar %s." : "Vi vil informere dig om at %s har udgivet kalenderen %s.",
    "Click on the link below to access it" : "Klik på link herunder for adgang",
