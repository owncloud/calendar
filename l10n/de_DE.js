OC.L10N.register(
    ...
    "Never" : "Nie",
    "Daily" : "Jeden Tag",
    "Weekly on {weekday}" : "Jede Woche am {weekday}",
    "Monthly on {day}" : "Jeden Monat am {day}",
    "Yearly on {day} of {month}" : "Jedes Jahr am {day} {month}",
    ...
    "Severe error in webcal proxy. Please contact administrator for more information." : "Server-Fehler im WebCal-Proxy. Bitte kontaktieren Sie Ihren Administrator für weitere Informationen.",
    ...
    "%s has published the calendar %s" : "%s hat den Kalender %s veröffentlicht",
    "Hello," : "Hallo,",
    "We wanted to inform you that %s has published the calendar {boldstart}%s{boldend}." : "Wir möchten Sie informieren, das %s den Kalender {boldstart}%s{boldend} veröffentlicht hat.",
    "Click here to access it" : "Hier klicken, um ihn zu öffnen",
    "Cheers!" : "Noch einen schönen Tag!",
    "We wanted to inform you that %s has published the calendar %s." : "Wir möchten Sie informieren, das %s den Kalender %s veröffentlicht hat.",
    ...
    "Maybe you got a wrong link or the calendar was unshared?" : "Vielleicht haben Sie einen falschen Link erhalten oder die Freigabe zum Kalender wurde entfernt?",
    ...
    "Repeat on every:" : "Wiederholen an jedem:",
    "of each month" : "von jedem Monat",
    "End:" : "Ende:",
    "never" : "niemals",
    "event(s)" : "Event(s)",
    "on" : "am",
