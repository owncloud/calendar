OC.L10N.register(
    ...
    "EMail has been sent." : "Το EMail εστάλη. ",
    "There was an issue while sending your EMail." : "Παρουσιάστηκε ένα σφάλμα κατά την προσπάθεια αποστολής της αλληλογραφίας.",
    ...
    "The remote server did not give us access to the calendar (HTTP {code} error)" : "Ο μακρινός κεντρικός υπολογιστής δεν μας έδωσε άδεια πρόσβασης στο ημερολόγιο(HTTP {code} error)",
    ...
    "Add" : "Προσθήκη",
    "E-Mail address of attendee" : "Διεύθυνση ηλεκτρονικής αλληλογραφίας συμμετέχοντα",
