OC.L10N.register(
    ...
    "Error requesting resource on remote server. This could possibly be related to a certificate mismatch" : "Error en la petición de recursos del servidor remoto. Esto puede deberse a un error con el certificado.",
    ...
    "Email has been sent." : "El email ha sido enviado.",
    ...
    "Maybe you got a wrong link or the calendar was unshared?" : "Quizas ha proporcionado un enlace no válido o el calendario puede que no este compartido.",
    ...
    "%s shared the calendar <strong>%s</strong> with you" : "%s ha compartido <strong>%s</strong> con tigo",
    "Embed" : "incrustado",
