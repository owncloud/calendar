OC.L10N.register(
    ...
    "Error requesting resource on remote server. This could possibly be related to a certificate mismatch" : "Villa við beiðni um tilfang á fjartengdum þjóni. Þetta gæti stafað af misræmi í skilríkjum (certificate mismatch)",
    ...
    "Email has been sent." : "Tölvupóstur var sendur.",
    ...
    "Never" : "Aldrei",
    "Daily" : "Daglegt",
    "Weekly on {weekday}" : "Vikulega á {weekday}",
    "Monthly on {day}" : "Mánaðarlega á {day}",
    "Yearly on {day} of {month}" : "Árlega {day} í {month}",
    "Custom" : "Sérsniðið",
    "Day(s)" : "dag(a)",
    "Week(s)" : "viku(r)",
    "Month(s)" : "mánuð(i)",
    ...
    "Delete this event " : "Eyða þessum atburði ",
    "Cancel" : "Hætta við",
    "More ..." : "Meira...",
    "Create" : "Búa til",
    "Update" : "Uppfæra",
    ...
    "Repeat on every:" : "Endurtaka hvern:",
    "of each month" : "hvers mánaðar",
    "End:" : "Enda:",
    "never" : "aldrei",
    "event(s)" : "atburðir",
    "on" : "á",
