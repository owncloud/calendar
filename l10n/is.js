OC.L10N.register(
    ...
    "The remote server did not give us access to the calendar (HTTP {code} error)" : "Fjartengdi þjónninn gaf ekki aðgang að dagatalinu (HTTP {code} villa)",
