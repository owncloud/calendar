OC.L10N.register(
    ...
    "Error requesting resource on remote server. This could possibly be related to a certificate mismatch" : "원격 서버 자원 요청 오류입니다. 인증서가 일치하지 않을 수도 있습니다",
    ...
    "Never" : "하지 않음",
    "Daily" : "매일",
    "Weekly on {weekday}" : "매주 {weekday}마다",
    "Monthly on {day}" : "매월 {day}마다",
    "Yearly on {day} of {month}" : "매년 {month} {day}마다",
    "Custom" : "사용자 정의",
    "Day(s)" : "일",
    "Week(s)" : "주",
    "Month(s)" : "개월",
