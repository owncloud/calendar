OC.L10N.register(
    ...
    "Tentative" : "Возможно",
    "Cancelled" : "Отменено",
    "Please add a title." : "Пожалуйста, Добавить заголовок.",
    ...
    "Monthly on {day}" : "Ежемесячно {day}го",
    "Yearly on {day} of {month}" : "Ежегодно в {month} {day}го",
    "Custom" : "Другое",
    "Day(s)" : "День(дни)",
    "Week(s)" : "Неделя(и)",
    "Month(s)" : "Месяц(ы)",
    ...
    "Please add your email address in the personal settings in order to add attendees." : "Пожалуйста, Добавить свой адрес электронной почты в личных настройках, чтобы добавить участников.",
    "from" : "из",
    "to" : "до",
