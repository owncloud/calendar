OC.L10N.register(
    ...
    "Click here to access it" : "Kliknute tu za dostop",
    "Cheers!" : "Lep pozdrav!",
    "We wanted to inform you that %s has published the calendar %s." : "Želimo vas obvestiti, da je %s objavil(a) koledar %s.",
